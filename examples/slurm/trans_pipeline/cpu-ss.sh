...
#SBATCH --job-name=cpu_proc
#SBATCH --gpus-per-node=8
#SBATCH --nodes=1
#SBATCH --exclusive
#SBATCH --time=04:00:00
#SBATCH -p batch_block1,batch_block3,batch_block4
#SBATCH --output=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_job/slurm-%j.out
#SBATCH --error=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_job/slurm-%j.err
...
export BASE_JOB_DIR=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_job
...
export SCRIPT_PATH=/lustre/fsw/portfolios/llmservice/users/uahmed/NeMo-Curator/examples/slurm/trans_pipeline/cpu_proc.py
export SCRIPT_COMMAND="python3 $SCRIPT_PATH \
    --input-data-dir=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_inp1 \
    --output-data-dir=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_out2 \
...
export CONTAINER_ENTRYPOINT=$BASE_DIR/NeMo-Curator/examples/slurm/trans_pipeline/cpu-ce.sh
...
export RMM_WORKER_POOL_SIZE="50GiB"
