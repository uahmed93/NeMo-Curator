...
#SBATCH --job-name=gpu_proc
#SBATCH --gpus-per-node=8
#SBATCH --nodes=8
#SBATCH --exclusive
#SBATCH --time=04:00:00
#SBATCH -p batch_block1,batch_block3,batch_block4
#SBATCH --output=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/gpu_job/slurm=%j.out
#SBATCH --error=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/gpu_job/slurm=%j.err
...
export BASE_JOB_DIR=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/gpu_job/
...
export SCRIPT_PATH=/lustre/fsw/portfolios/llmservice/users/uahmed/NeMo-Curator/examples/slurm/trans_pipeline/gpu_proc.py
export SCRIPT_COMMAND="python3 $SCRIPT_PATH \
    ...
    --tgt-lang=hin_Deva --input-data-dir=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/cpu_out1/ \
    --output-data-dir=/lustre/fsw/portfolios/llmservice/users/uahmed/orig_inputs/very_large_files/demo/gpu_out1/ \
    --input-text-field=indic_proc_text --files-per-partition 1 \
    --scheduler-file $SCHEDULER_FILE  --rmm-pool-size 5GB \
    --device $DEVICE"
...
export CONTAINER_ENTRYPOINT=$BASE_DIR/NeMo-Curator/examples/slurm/trans_pipeline/gpu-ce.sh
...
export RMM_WORKER_POOL_SIZE="40GiB"
export LIBCUDF_CUFILE_POLICY=OFF
export DASK_DATAFRAME__QUERY_PLANNING=False

export NEMO_CURATOR_DIR=/lustre/fsw/portfolios/llmservice/users/uahmed/NeMo-Curator
export CROSSFIT_DIR=/lustre/fsw/portfolios/llmservice/users/uahmed/crossfit_latest
# =================================================================
