...
# Change paths accodingly
cd $CROSSFIT_DIR;
pip install --extra-index-url https://pypi.nvidia.com ".[cuda12x]" --no-deps ;
pip install cudf-cu12==24.8.3 --extra-index-url=https://pypi.nvidia.com
pip install dask-cudf-cu12==24.8.3 --extra-index-url=https://pypi.nvidia.com
